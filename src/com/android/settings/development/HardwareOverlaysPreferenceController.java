...
public class HardwareOverlaysPreferenceController extends DeveloperOptionsPreferenceController
    ...
    protected void onDeveloperOptionsSwitchDisabled() {
        ...
        final SwitchPreferenceCompat switchPreferenceCompat = ((SwitchPreferenceCompat) mPreference);
    ...
    void updateHardwareOverlaysSetting() {
        ...
        try {
            ...
            (((SwitchPreferenceCompat) mPreference)).setChecked(disableOverlays != SETTING_VALUE_OFF);
            reply.recycle();
            data.recycle();
